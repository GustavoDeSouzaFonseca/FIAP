...
public class Teste {
	...
	public static void main(String[] args) {
		...
		System.out.println("Seu CPF é: " + cn.cpf);
		System.out.println("Rua " + end.rua + ", Nº" + end.numero + ", " + end.complemento);
		System.out.println("Bairro " + end.bairro + ", CEP: " + end.cep);
		System.out.println("O SEU SALDO DA SUA CONTA CORRENTE É DE: " + cc.saldo);
